// Vendored from muxr-core (MIT) — muxrd/src/multiplexer/herdr/wire.rs.
// Independently-authored types matching herdr's public v0.7.1 wire protocol;
// not derived from herdr's AGPL source.
